...
- Run ID: `run-20260728T091848Z-deepseek-chat-official-typed-l1-dev-v9`
- Cases: `12`
...
- Error taxonomy: `{'condition_or_scope_error': 1, 'lifecycle_error': 1, 'role_or_local_entity_error': 1}`
...
- Gate reasons: `{'lifecycle_not_authorized': 1}`
