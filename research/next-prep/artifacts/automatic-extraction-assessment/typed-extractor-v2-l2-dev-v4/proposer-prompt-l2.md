# Typed Extractor V2 L2 Dev Proposer Contract V4
...
4. Select the L2 operator and abstraction for the resolved cross-turn meaning.
   ...
   form uses the catalog's `transform_...` operator/sense and
   `lifecycle_resolution`. A requested task assembled from prerequisite,
   ...
   state transition nor task composition applies.
