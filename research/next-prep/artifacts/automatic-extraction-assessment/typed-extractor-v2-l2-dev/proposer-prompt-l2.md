# Typed Extractor V2 L2 Dev Proposer Contract V1
...
- `kind`, abstraction method, closure pattern, predicate sense, canonical
  ...
  selected by meaning.
- Claim-local entities are contiguous `entity-01`, `entity-02`, and so on.
  Every role references a local entity. Copy entity surfaces from public text
  or typed L1 supports; do not create global entity identity.
...
and null typed candidate for every abstention. Emit JSON only.
