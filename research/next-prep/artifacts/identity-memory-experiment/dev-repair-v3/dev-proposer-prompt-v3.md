...
`/public/home/wwb/KE-mem/KE-memory-next-prep-20260727/.tmp/identity-proposer-stage/run-20260727T154000Z-claude-sonnet-4-6-dev-policy-v3/proposals.json`

Use this exact run metadata:

- `schema_version`: `natural-identity-proposals-v1`
- `run_id`: `run-20260727T154000Z-claude-sonnet-4-6-dev-policy-v3`
