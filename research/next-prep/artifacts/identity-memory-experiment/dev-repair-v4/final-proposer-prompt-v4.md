...
`/public/home/wwb/KE-mem/KE-memory-next-prep-20260727/.tmp/identity-proposer-stage/run-20260728T030000Z-codex-gpt-5-6-sol-fresh-v4/proposals.json`

Use this exact run metadata:

- `schema_version`: `natural-identity-proposals-v1`
- `run_id`: `run-20260728T030000Z-codex-gpt-5-6-sol-fresh-v4`
