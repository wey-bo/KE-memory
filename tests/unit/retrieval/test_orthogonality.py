...
from ke_memory_demo.retrieval import EmbeddingRetriever, RetrievalCoordinator, SourceFragment
...
async def test_candidate_paths_meet_only_in_evidence_fusion() -> None:
    ...
    result = await RetrievalCoordinator(symbolic, embedding, matcher, fusion).retrieve(
        "question"
    )
